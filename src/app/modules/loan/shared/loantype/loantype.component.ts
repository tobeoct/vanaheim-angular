...
const data:any[] = [
  {id:"PayMe Loan",title:"Salary Earners' Loans", uniqueName:"PayMe Loan",frequency:"Monthly",subtitle:"Need a loan for house rent, to buy a new phone or to fix your car?", description:"Take personal loans between NGN 25,000 to NGN 5M and pay back monthly."},
  {id:"FundMe Loan",title:"Business (SME) Loan",uniqueName:"FundMe Loan",frequency:"Monthly",subtitle:"Need a loan to grow your business?", description:"Get business loans up to NGN 5M with no application fees at affordable interest rates."},
  {id:"LPO Finance",title:"Local Purchase Order", uniqueName:"LPO Finance",frequency:"Monthly",subtitle:"Are you a contractor, vendor or a supplier in need of funding to execute a project?", description:"Get access to loans up to NGN 5M for your local purchase order projects."},
  {id:"FloatMe Loan",uniqueName:"FloatMe Loan", title:"Emergency/Quick Cash",frequency:"Daily",subtitle:"Dealing with emergency expenses at mid-month?", description:"Get loans up to NGN 5M naira and pay back daily or weekly in.", action:"Float Me"},
 ]
@Component({
...
export class LoantypeComponent implements OnInit {
  ...
  items:RadioButtonItem[] = [{label:"For Individual",value:"FloatMe (Personal)",selected:true},{label:"For Business",value:"FloatMe (Business)",selected:false}]
  ...
  ngOnInit(): void {
    ...
    this.form = this._fb.group({
      ...
      choice: ['FloatMe (Personal)',[Validators.required]]
    })
