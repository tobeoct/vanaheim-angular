...
export class LoanCalculatorComponent implements OnInit {
  ...
  onSubmit=(form:any)=>{
    const loanDetails:LoanDetails = {monthlyRepayment:this.monthlyRepaymentSubject.value,loanAmount: this.loanAmount.value, tenure:this.tenure.value, denominator: this.tenureDenominatorSubject.value,purpose:this.purpose.value, totalRepayment: this.totalRepaymentSubject.value};
