...
export class NOKInfoComponent implements OnInit {
  ...
  constructor(private _router: Router, private _utility: Utility, private _fb: FormBuilder, private _store: Store,private _earningsStore:EarningsStore,
  ...
  ngOnInit(): void {
    ...
    const nokInfo = this._earningsStore.nokInfo as NOKInfo;
    ...
    this._earningsStore.titleSubject.next("Next Of Kin Information");
  ...
  onSubmit = (form: FormGroup) => {
    ...
    this._earningsStore.setNOKInfo(nokInfo);
    if (!this.side) {
      this.onNavigate("means-of-identification");
    } else {
